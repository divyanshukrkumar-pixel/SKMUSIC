...
from DEVA.core.dir import CACHE_DIR 
...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("DEVA/assets/thumb/font2.ttf", 32)
        regular_font = ImageFont.truetype("DEVA/assets/thumb/font.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "DEVA/assets/thumb/play_icons.png"
